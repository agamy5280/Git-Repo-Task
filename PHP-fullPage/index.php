      ...
      <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
        <a class="text-decoration-none" href="">
          <div class="cat-item d-flex align-items-center mb-4">
            <div class="overflow-hidden" style="width: 100px; height: 100px"></div>
            <img class="img-fluid" src="<?= $cat['img'] ?>" alt="<?= $cat['name'] ?>" />
          </div>
          <div class="flex-fill pl-3">
            <h6><?= $cat['name'] ?></h6>
            <small class="text-body"><?= $cat['productNumber'] ?></small>
          </div>
      </div>
      </a>
      <?php
