...
require_once("../php/products_db.php");
...
<a href="add-products.php"><button type="button" class="btn btn-success" id="add-btn">Add</button></a>
</div>
</body>
